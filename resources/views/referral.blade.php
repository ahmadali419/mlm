        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="text-center">Create an Referral account</h3>
                            ...
                            <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate"
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <input class="form-control form-control-lg form-control-solid" type="text"
                                        name="full_name" autocomplete="off" value="{{ old('full_name') }}">
                                ...
                                <div class="fv-row mb-7">
                                 ...
                                 <input id="phone"class="form-control" name="phone" type="tel" autocomplete="off" value="{{ old('phone') }}" required="">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input class="form-control form-control-lg form-control-solid" type="text"
                                        name="sponser_code" autocomplete="off" value="{{$id}}">
                                </div>
                                @if ($errors->has('sponsor_code'))
                                    <span class="text-danger">{{ $errors->first('sponsor_code') }}</span>
                                @endif
                                <!--end::Input group-->
...
@section('js')
   ...
   nationalMode: false,
      ...
      utilsScript: "{{asset('assets/js/Util.js')}}",
            ...
            var validator = $("#kt_sign_up_form").validate({
                rules: {
                    full_name: {
                        required: true
                    },
